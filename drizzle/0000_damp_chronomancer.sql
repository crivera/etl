...
--> statement-breakpoint
ALTER TABLE "etl_document_extractions" ADD CONSTRAINT "etl_document_extractions_document_id_etl_document_id_fk" FOREIGN KEY ("document_id") REFERENCES "public"."etl_document"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "etl_field_groups" ADD CONSTRAINT "etl_field_groups_user_id_etl_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."etl_user"("id") ON DELETE no action ON UPDATE no action;